...
public partial class TwitterTest : System.Web.UI.Page
{
     ...
     protected async void Page_Load(object sender, EventArgs e)
     {
         auth = new AspNetAuthorizer
         {
             ...
             {
                 ConsumerKey = "V8hxRShT36qky2v01PrtrRKPY", // ConfigurationManager.AppSettings["consumerKey"],
                 ConsumerSecret = "XiF6GfDYYBPWZ9NcxumTkDucmkQpvInMqrhtcQhGmdZhYjIj54", //ConfigurationManager.AppSettings["consumerSecret"]
             },
    ...
    {
        await auth.BeginAuthorizeAsync(new Uri("https://localhost:44300/TwitterTest.aspx"));
    }
}
