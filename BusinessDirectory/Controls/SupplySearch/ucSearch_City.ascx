...
<asp:DataList ID="DataList1" runat="server" RepeatColumns="6">
    <ItemTemplate>
        <table>
            <tr>
                <td>
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%#"~/ServiceBrowsing/CategoryCityList.aspx?CityID=" + Eval("ID").ToString()+ "&CategoryID=" + CategoryID + "&Type=CategoryBrowsing"  %>'
